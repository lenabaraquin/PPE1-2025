...
for ANNEE in 2016 2017 2018; do
  ...
  echo Annotations Location pour l annee $ANNEE : $(cat * | grep Location | wc -l) #On lit tous les fichiers du répertoire (fichiers d'annotations pour l'année courante de la boucle) avec cat, on selectionne les lignes contenant Location avec grep et on compte ces lignes avec wc -l.
