...
if [[ !($1 =~ [A-Z][a-z]+) ]]; then
  echo "Renseigner l'étiquette en premier argument, doit être une chaine de caractère commençant par une majuscule."
fi

TAG=$1 #L'étiquette est donnée par le premier argument du script
